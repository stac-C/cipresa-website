      ...
      >
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            >
              <div className="flex h-44 items-center justify-center rounded-[20px] bg-gradient-to-br from-cipresa-50 to-emerald-50 text-center text-slate-600">
            ...
            <motion.div
              ...
              className="rounded-[24px] border border-dashed border-cipresa-200 bg-white/80 p-4 shadow-sm"
            >
              <div className="flex h-44 items-center justify-center rounded-[20px] bg-gradient-to-br from-amber-50 to-orange-50 text-center text-slate-600">
                <div className="space-y-2">

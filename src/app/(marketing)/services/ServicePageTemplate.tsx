...
export default function ServicePageTemplate({
  ...
  intro,
  highlights,
  imageTitle = 'Illustration du service',
  imageDescription = 'Zone d’image prête à être branchée sur une image métier ou un visuel de démonstration.',
    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h2 className="text-2xl font-semibold text-slate-950">Prêt à avancer sur vos objectifs ?</h2>
            <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-600">
              Contactez notre équipe pour discuter de vos besoins et définir le programme le plus adapté à votre contexte.
            </p>
          </div>
